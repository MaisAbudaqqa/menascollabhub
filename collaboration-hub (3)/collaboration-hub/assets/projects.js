...
(function () {
  ...
  function openShareModal(scopeType, scopeId, scopeName, projectName) {
    ...
    openModal(html, function (overlay) {
      ...
      overlay.querySelector("#sh-generate").addEventListener("click", function () {
  ...
  function init() {
    ...
    // Pull latest access statuses from serverless function on page load
    (async function syncNetlifyStatuses() {
      try {
